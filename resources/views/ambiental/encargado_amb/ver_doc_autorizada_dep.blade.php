        ...
        <div class="row">
            <div class="col-md-10 col-xs-10 col-md-offset-1">
                <p>
                    ...
                    <a href="{{url("/ambiental/historial_documentacion")}}">Historial de los procedimientos de ambiental </a>
                    <span class="glyphicon glyphicon-chevron-right"></span>
                    <span>Documentación del Procedimiento Autorizado</span>
                </p>
                <br>
            </div>
        </div>
                ...
                <div class="col-md-8 col-md-offset-2">
                    <div class="panel panel-info">
                        <div class="panel-heading">
                            <h3 class="panel-title text-center">Documentación Autorizada  del periodo {{ $periodo[0]->nombre_periodo_amb }} <br>
