<!-- Modal -->
<div  class="modal" :class="{mostrar:modal_mod_encar}" >
    <div class="modal-dialog modal-lg">

        <!-- Modal content-->
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" @click="cerrarModal_mod();">&times;</button>
            ...
            <div class="modal-body">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-default" @click="cerrarModal_mod();">Cerrar</button>
                    <button type="button" class="btn btn-success" @click="guardar_encargado_mod();" :disabled="estadoguardar">Guardar</button>
                </div>
            </div>
        </div>
