...
@section('content')
    ...
    {{--
        <a href="{{ url("riesgos/proceso")}}"  class="btn btn-primary btn-lg text-center" >
            ...
            <div class="col-md-5 col-md-offset-3">
                ...
                <div class="panel panel-info">
                    <div class="panel-heading">
                        <h3 class="panel-title text-center">Partes Interesadas del proceso, procedimiento o control de
                            actividad</h3>
                    </div>
                </div>
            </div>
                        ...
                        <div class="panel ">
                            <div class="panel-heading">
                                ...
                                <a data-toggle="collapse" data-parent="#accordion"
                                   href="#collapse{{$parte_unidad->id_uni_p}}" data-id="{{$parte_unidad->id_uni_p}}"
                                   class="btn_open_panel">{{$parte_unidad->parte[0]->des_parte}}</a>
                                {{--Nuevo icono eliminar --}}
                                <a href="#!" class="pull-right btn_delete_unidad_partes"
                                   data-id="{{$parte_unidad->id_uni_p}}"><span class="glyphicon glyphicon-trash"
                                                                               data-toggle="tooltip"
                                                                               title="Eliminar parte interesada "></span></a>
                                {{--</h3>--}}
                            </div>
                            <div id="collapse{{$parte_unidad->id_uni_p}}"
                                 class="panel-collapse collapse {{ Session::get('collapseStatepartes')==$parte_unidad->id_uni_p?'in':'' }}">
                                            ...
                                            <div class="panel-heading">
                                                <h3 class="panel-title text-center">Requisitos
                                                    <a href="#!" data-toggle="modal"
                                                       data-id="{{$parte_unidad->id_uni_p}}"
                                                       data-target="#modal_crear_requisito"
                                                       class="pull-right  btn_crear_requisito">
                                                        <span class="glyphicon glyphicon-plus" aria-hidden="true"
                                                              data-toggle="tooltip" title="Agregar"></span>
                                                    </a>
                                                </h3>
                                            </div>
                                        </div>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="row">
                                                            <div class="col-md-10">
                                                                <a href="#!" data-toggle="modal"
                                                                   data-id="{{$requisito->id_requisito}}"
                                                                   data-target="#modal_crear_requisito_riesgo"
                                                                   class="btn_crear_requisito_riesgo">
                                                                    <span class="glyphicon glyphicon-plus"
                                                                          aria-hidden="true" data-toggle="tooltip"
                                                                          title="Agregar riesgo"></span>
                                                                </a>
                                                            </div>
                                                        </div>
                                                        <div class="row">
                                                                    ...
                                                                    @foreach($requisito->riesgos as $riesgo_requisito)
                                                                        <li class="list-group-item">
                                                                            <div class="row">
                                                                                ...
                                                                                <div class="col-md-2">
                                                                                    <a href="#!"
                                                                                       class="btn_delete_riesgo_requisito pull-right"
                                                                                       data-id="{{$riesgo_requisito->id_riesgo}}"><span
                                                                                                aria-hidden="true"
                                                                                                class="glyphicon glyphicon-trash"
                                                                                                data-toggle="tooltip"
                                                                                                title="Eliminar riesgo"></span></a>
                                                                                </div>
                                                                                <div class="col-md-2">
                                                                                    <a href="#!"
                                                                                       class="pull-right btn_edit_info"
                                                                                       data-toggle="modal"
                                                                                       data-target="#modal_modificar_datos"
                                                                                       data-url="riesgos/riesgo/{{$riesgo_requisito->id_riesgo}}"
                                                                                       data-info_edit="{{$riesgo_requisito->des_riesgo}}"><span
                                                                                                aria-hidden="true"
                                                                                                class="glyphicon glyphicon-cog"
                                                                                                data-toggle="tooltip"
                                                                                                title="Editar riesgo"></span></a>
                                                                                </div>
                                                                            </div>
                                                                        </li>
                                                                    @endforeach
                                                    ...
                                                    <td>
                                                        <div class="row">
                                                            <div class="col-md-10">
                                                                <a data-toggle="modal"
                                                                   data-id="{{$requisito->id_requisito}}"
                                                                   data-target="#modal_crear_requisito_oportunidad"
                                                                   class="btn_crear_requisito_oportunidad">
                                                                    <span class="glyphicon glyphicon-plus"
                                                                          aria-hidden="true" data-toggle="tooltip"
                                                                          title="Agregar oportunidad"></span>
                                                                </a>
                                                            </div>
                                                        </div>
                                                        <div class="row">
                                                                ...
                                                                <ul class="list-group">
                                                                    @foreach($requisito->oportunidades as $riesgo_oportunidad)
                                                                        <li class="list-group-item">
                                                                            <div class="row">
                                                                                <div class="col-md-9">
                                                                                    <a href="{{url('riesgos/regoportunidad')."/".$riesgo_oportunidad->id_oportunidad}}"
                                                                                       class="">{{$riesgo_oportunidad->des_oportunidad}}</a>
                                                                                </div>
                                                                                <div class="col-md-1"></div>
                                                                                <div class="col-md-1">
                                                                                    <a class="btn_delete_oportunidad_requisito pull-right"
                                                                                       data-id="{{$riesgo_oportunidad->id_oportunidad}}"><span
                                                                                                aria-hidden="true"
                                                                                                class="glyphicon glyphicon-trash"
                                                                                                data-toggle="tooltip"
                                                                                                title="Eliminar oportunidad"></span></a>
                                                                                </div>
                                                                                <div class="col-md-1">
                                                                                    <a class="pull-right btn_edit_info"
                                                                                       data-toggle="modal"
                                                                                       data-target="#modal_modificar_datos"
                                                                                       data-url="riesgos/regoportunidad/{{$riesgo_oportunidad->id_oportunidad}}"
                                                                                       data-info_edit="{{$riesgo_oportunidad->des_oportunidad}}"><span
                                                                                                aria-hidden="true"
                                                                                                class="glyphicon glyphicon-cog"
                                                                                                data-toggle="tooltip"
                                                                                                title="Editar oportunidad"></span></a>
                                                                                </div>
                                                                            </div>
                                                                        </li>
                                                                    @endforeach
                                                    ...
                                                    <td>
                                                        <a class="btn_delete_requisito_riesgo"
                                                           data-id="{{$requisito->id_requisito}}"><span
                                                                    aria-hidden="true" class="glyphicon glyphicon-trash"
                                                                    data-toggle="tooltip"
                                                                    title="Eliminar requisito"></span></a>
                                                        <a class="pull-right btn_edit_info" data-toggle="modal"
                                                           data-target="#modal_modificar_datos"
                                                           data-url="riesgos/requisitos/{{$requisito->id_requisito}}"
                                                           data-info_edit="{{$requisito->des_requisito}}"><span
                                                                    aria-hidden="true" class="glyphicon glyphicon-cog"
                                                                    data-toggle="tooltip"
                                                                    title="Editar requisito"></span></a>
                                                    </td>
                                                </tr>
                                            @endforeach
                                            </tbody>
    ...
    <div>
        <button data-toggle="modal" data-tooltip="true" data-placement="left" title="Agregar nueva parte interesada"
                data-target="#modal_crear" type="button" class="btn btn-success btn-lg flotante">
    ...
    <form id="form_requisito" class="form" role="form" method="POST" action="{{url('riesgos/requisitos')}}">
        <div class="modal fade" id="modal_crear_requisito" tabindex="-1" role="dialog"
    ...
    <form id="form_requisito_riesgo" class="form" role="form" method="POST" action="{{url('riesgos/riesgo')}}">
        <div class="modal fade" id="modal_crear_requisito_riesgo" tabindex="-1" role="dialog"
             aria-labelledby="exampleModalLabel">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
    ...
    <form id="form_requisito_oportunidad" class="form" role="form" method="POST"
          action="{{url('riesgos/regoportunidad')}}">
        <div class="modal fade" id="modal_crear_requisito_oportunidad" tabindex="-1" role="dialog"
             aria-labelledby="exampleModalLabel">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="oportunidad"
    ...
    <form id="form_modificar_datos" class="form" role="form" method="POST">
        <div class="modal fade" id="modal_modificar_datos" tabindex="-1" role="dialog"
             aria-labelledby="exampleModalLabel">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="des_dato_modificar"
                                           id="des_dato_modificar">
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <script>
        $(document).ready(function () {
            ...
            $(".btn_open_panel").click(function () {
                $.get("{{url('riesgos/add_partes/collapse')}}/" + $(this).data("id"));
            });
