                                    ...
                                    <table class="table text-center my-0 border-table">
                                        ...
                                        @foreach($materia['grupos'] as $grupo)
                                            <tr>
                                                <td>{{$grupo['grupos']}}</td>
                                                <td>
                                                    <a href="/j_carrera/periodos/{{$docente['id_personal']}}/{{$materia['id_materia']}}/{{$grupo['id_grupo']}}" class="btn btn-primary tooltip-options link" data-toggle="tooltip" data-placement="top" title="Periodos"><span class="oi oi-calendar"></span></a>
                                                    <a href="/j_carrera/acciones/calificaciones/{{$docente['id_personal']}}/{{$materia['id_materia']}}/{{$grupo['id_grupo']}}" class="btn btn-primary tooltip-options link" data-toggle="tooltip" data-placement="top" title="Evaluaciones"><span class="oi oi-pencil"></span></a>
                                                    @if($periodo_sumativas)
                                                        <a href="/j_carrera/{{$docente['id_personal']}}/{{$materia['id_materia']}}/{{$materia ['id_semestre']}}/{{$grupo['id_grupo']}}/{{$carrera['nombre_carrera']}}/sumativas" class="btn btn-warning tooltip-options link" data-toggle="tooltip" data-placement="top" title="Evaluación sumativa de complementación"><span class="oi oi-pencil"></span></a>
                                                    @else
                                                    @endif
                                                </td>
                                            </tr>
