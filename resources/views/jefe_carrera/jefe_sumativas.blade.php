                ...
                <div class="panel-body">
                    <div class="row col-md-12">
                        ...
                        <label for="" class="col-md-12 text-right">
                            ...
                            <input type="{{  ($calificada_sumativa==1 ? 'button' : 'hidden') }}" class="btn btn-primary tooltip-options link" id="link_genera_pdf" name="link_genera_pdf" data-toggle="tooltip" data-placement="top" title="Generar acta de calificaciones" target="_blank" value="Imprimir PDF">
                            <input type="{{  ($calificada_sumativa==1 ? 'button' : 'hidden') }}"class="btn btn-info tooltip-options link" id="link_genera_pdf_jc" name="link_genera_pdf_jc" data-toggle="tooltip" data-placement="top" title="Generar acta de calificaciones" target="_blank" value="Imprimir PDF con nuevo responsable">
                        </label>
                    </div>
                </div>
            </div>
    ...
    <script type="text/javascript">
        $(document).ready(function()
        {
            ...
            $("#link_genera_pdf_jc").click(function(event) {
                var link="/generar_pdf_sumativas/jc?id_docente="+ {{ $id_docente }} +"&id_materia="+ {{ $id_materia }} +"&unidades="+ {{ $unidades }}+"&id_grupo="+ {{ $id_grupo }}+"&nomjefe={{ Session::get('nombre') }}";
                window.open(link);
            });
