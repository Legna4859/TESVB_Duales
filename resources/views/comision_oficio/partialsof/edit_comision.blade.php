                ...
                @if($mensaje == 1)
                    <div class="row ">
                        <div class="col-md-7 col-md-offset-1">
                            <label class=" alert alert-danger text-center"  data-toggle="tab" ><h5>Si requiere modificar el dia  del horario de salida o el dia  del horario de regreso se eliminaran el comisionado o los comisionados agregados a esta comisión los cuales son:<br>
                               @foreach($comisionadosauto as $comisionado)
                                   <p>{{$comisionado->nombre}}</p>
                                @endforeach</h5></label>
                        </div>
                    </div>
                @endif
