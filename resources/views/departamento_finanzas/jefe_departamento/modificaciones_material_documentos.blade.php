    ...
    <div class="row">
        <div class="col-md-10 col-xs-10 col-md-offset-1">
            <p>
                ...
                <a href="{{url("/presupuesto_anteproyecto/modificar_requisicones/".$datos_req_envio->id_req_mat_ante)}}">Actividades de requisiciones del anteproyecto </a>
                <span class="glyphicon glyphicon-chevron-right"></span>
                <span>Modificaciones de bienes o servicios, etc. a la requisición de materiales</span>
            </p>
            <br>
        </div>
    </div>
            ...
            <div class="panel panel-info">
                <div class="panel-heading">
                    @if($id_autorizacion == 0)
                        <h2 class="panel-title text-center">Agregar bienes o servicios, etc. a la requisición de materiales</h2>
                    @else
                    <h2 class="panel-title text-center">Modificaciones bienes o servicios, etc. a la requisición de materiales</h2>
                    @endif
    ...
    <div class="row">
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-danger">
                <div class="panel-heading">
                     <h3 class="panel-title text-center">COMENTARIO DE MODIFICACIONES: <b>{{ $requisiciones2[0]['comentario'] }}</b></h3>
                </div>
            </div>
        </div>
    </div>
