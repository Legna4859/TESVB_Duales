...
<form  id="form_guardar_cotizacion_pdf" action="{{url("/presupuesto_anteproyecto/guardar_cotizacion_pdf/".$requisicion->id_actividades_req_ante)}}" role="form" method="POST" enctype="multipart/form-data" >
    {{ csrf_field() }}
        ...
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-success">
                <div class="panel-heading">
                    <label>Seleccionar  cotización pdf</label>
