@extends('layouts.app')
@section('title', 'Requisiciones autorizadas del anteproyecto')
@section('content')
    <div class="row">
        <div class="col-md-8  col-md-offset-2">
            <div class="panel panel-info">
                <div class="panel-heading">
                    <h3 class="panel-title text-center">Requisiciones revisadas del anteproyecto del año {{ $datos_req_envio->year_requisicion }}</h3>
                    </div>
            </div>
        </div>
        <br>
                            ...
                            <div class="row">
                                <div class="col-md-8  col-md-offset-2">
                                    <div class="panel panel-danger">
                                        <div class="panel-heading">
                                            <h4 style="text-align: center">Requisición rechazada</h4>
                                        </div>
                                    </div>
                                </div>
                                <br>
