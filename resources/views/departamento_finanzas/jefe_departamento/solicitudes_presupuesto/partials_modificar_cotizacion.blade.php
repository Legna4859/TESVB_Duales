<form  id="form_guardar_mod_cotizacion" action="{{url("/presupuesto_autorizado/guardar_cotizacion/".$id_solicitud)}}" role="form" method="POST" enctype="multipart/form-data" >
    {{ csrf_field() }}
        ...
        <div class="col-md-10 col-md-offset-1">
            <div class="panel panel-success">
                <div class="panel-heading">
                    ...
                    <input class="form-control"  id="cotizacion_mod_pdf" name="cotizacion_mod_pdf" type="file"   accept="application/pdf" required/>
                </div>
            </div>
        </div>
    </div>
