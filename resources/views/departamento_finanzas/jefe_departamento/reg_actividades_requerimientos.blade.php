                    ...
                    <div class="panel-heading">
                        ...
                        <div class="row">
                            <div class="col-md-3 col-md-offset-4">
                                <button class="btn btn-primary btn-lg" onclick="window.location='{{ url('/presupuesto_anteproyecto/agregar_bienes_servicios_anteproyecto/'.$requisicion['id_actividades_req_ante'] ) }}'">Agregar documentación o bienes o servicios, etc.</button>
                            </div>
            ...
            @if($estado_documentacion == false and $estado_material == false)
                    ...
                    <div class="row">
                        <div class="col-md-2 col-md-offset-5">
                            <button  id="{{ $id_req_mat_ante }}"  class="btn btn-success btn-lg  enviar_requisiciones" >Enviar requisiciones
                            </button>
                        </div>
                    </div>
                    @endif
                        ...
                        <div class="row">
                            <div class="col-md-10 col-md-offset-1 ">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" id="justificacion" name="justificacion" rows="3" placeholder="Ingresa justificación" onkeyup="javascript:this.value=this.value.toUpperCase();"></textarea>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <input type="hidden" id="id_req_mat_ante" name="id_req_mat_ante" value="">
                                <h2 style="text-align: center;">¿ Seguro(a) que quieres enviar las requisiciones a la Dirección de Administración y Finanzas</h2>
                            </form>
                            <div class="modal-footer">
                                <button type="button" class="btn btn-default" data-dismiss="modal">Cancelar</button>
