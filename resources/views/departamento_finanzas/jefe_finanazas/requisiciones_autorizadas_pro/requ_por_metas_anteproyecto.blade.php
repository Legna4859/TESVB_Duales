    ...
    <div class="row">
        <div class="col-md-10 col-xs-10 col-md-offset-1">
            <p>
                ...
                <span class="glyphicon glyphicon-chevron-right"></span>
                <span>Requisiciones autorizadas por meta</span>
            </p>
            <br>
        </div>
    </div>
        ...
        <div class="col-md-6  col-md-offset-3">
            <div class="panel panel-info">
                <div class="panel-heading">
                    <h3 class="panel-title text-center">Requisiciones autorizadas por meta  del presupuesto del anteproyecto {{ $proyecto->year }}  <br>  (Nombre del proyecto: {{ $proyecto->nombre_proyecto }})
                    </h3>
                </div>
            </div>
        </div>
    ...
    @if($mostrar == 1)
        ...
        <div class="row">
            <div class="col-md-2 col-md-offset-8">
                <a href="/presupuesto_anteproyecto/presupuesto_metas_ant_excel/{{ $id_presupuesto }}/{{ $id_meta }}" class="btn btn-primary" target="_blank"><span class="glyphicon glyphicon-export"  aria-hidden="true"></span>Exportar Excel</a>
            </div>
        </div>
        <div class="row">
            <div class="col-md-2 col-md-offset-6">
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            $("#id_meta").on('change',function(e) {
                ...
                window.location.href='/presupuesto_anteproyecto/ver_proyecto_meta_anteproyecto/'+id_meta+'/{{ $id_presupuesto }}';
