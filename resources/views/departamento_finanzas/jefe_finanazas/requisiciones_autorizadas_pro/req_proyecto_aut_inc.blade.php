    ...
    <div class="row">
        <div class="col-md-10 col-xs-10 col-md-offset-1">
            <p>
                ...
                <span class="glyphicon glyphicon-chevron-right"></span>
                <span>Requisiciones autorizadas del proyecto sin partidas en 0 </span>
            </p>
            <br>
        </div>
    </div>
        ...
        <div class="col-md-6  col-md-offset-3">
            <div class="panel panel-info">
                <div class="panel-heading">
                    <h3 class="panel-title text-center">Requisiciones autorizadas del anteproyecto de presupuesto {{ $proyecto->year }}<br>
