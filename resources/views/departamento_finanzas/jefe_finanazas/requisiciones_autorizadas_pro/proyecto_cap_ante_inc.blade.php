    ...
    <div class="row">
        <div class="col-md-10 col-xs-10 col-md-offset-1">
            <p>
                ...
                <span class="glyphicon glyphicon-chevron-right"></span>
                <span>Requisiciones autorizadas por capitulo sin partidas presupuestales en 0 </span>
            </p>
            <br>
        </div>
    </div>
        ...
        $(document).ready(function() {
            ...
            $("#id_fuente_financiamiento").on('change',function(e) {
                ...
                var id_fuente_financiamiento = $("#id_fuente_financiamiento").val();
                 ...
                 window.location.href='/presupuesto_anteproyecto/ver_proyecto_capitulo_anteproyecto_inc/'+id_fuente_financiamiento;
