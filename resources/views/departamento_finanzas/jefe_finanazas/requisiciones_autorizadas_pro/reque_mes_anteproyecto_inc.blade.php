    ...
    <div class="row">
        <div class="col-md-10 col-xs-10 col-md-offset-1">
            <p>
                ...
                <span class="glyphicon glyphicon-chevron-right"></span>
                <span>Requisiciones autorizadas por mes sin partidas presupuestales en 0</span>
            </p>
            <br>
        </div>
    </div>
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            $("#id_mes").on('change',function(e) {
                ...
                window.location.href='/presupuesto_anteproyecto/ver_proyecto_mes_anteproyecto_inc/'+id_mes+'/{{ $id_presupuesto }}';
