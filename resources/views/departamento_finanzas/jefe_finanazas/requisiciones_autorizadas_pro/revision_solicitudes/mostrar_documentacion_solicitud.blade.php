    ...
    <div class="row">
        <div class="col-md-10 col-xs-10 col-md-offset-1">
            <p>
                ...
                <span class="glyphicon glyphicon-arrow-right"></span>
                <a href="{{url("/presupuesto_autorizado/solicitudes_ver_departamento/".$departamento->id_unidad_admin)}}">Solicitudes de requisiciones del departamento o de la jefatura</a>
        ...
        <div class="col-md-8  col-md-offset-2">
            <div class="panel panel-info">
                <div class="panel-heading">
                    <h3 class="panel-title text-center">Documentacion de la solicitud del departamento o jefatura: {{ $departamento->nom_departamento }}
