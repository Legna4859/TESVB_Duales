    ...
    <div class="row">
        <div class="col-md-10 col-xs-10 col-md-offset-1">
            <p>
                ...
                <span class="glyphicon glyphicon-arrow-right"></span>
                <a href="{{url("/presupuesto_anteproyecto/revicion_req_departamento/".$id_req_mat_ante)}}">Requisiciones del departamento </a>
                <span class="glyphicon glyphicon-chevron-right"></span>
                <span>Requisición Autorizada</span>
            </p>
            <br>
        </div>
    </div>
        ...
        <div class="col-md-8  col-md-offset-2">
            <div class="panel panel-info">
                <div class="panel-heading">
                    <h3 class="panel-title text-center">REQUISICIÓN AUTORIZADA <br>
        ...
        <div class="row">
            <div class="col-md-6 col-md-offset-3">
                <div class="panel panel-danger">
                    <div class="panel-heading">
                        <h5 style="text-align: center">{{ $requisiciones[0]->comentario }}</h5>
                    </div>
                </div>
            </div>
        </div>
