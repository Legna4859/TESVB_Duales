...
@section('content')
        ...
        <div class="row col-md-11 col-md-offset-1">
            <ul class="nav nav-tabs">
                <li class="active"><a href="#">Revisar requisiciones</a></li>
                <li>
                    <a href="{{ url('/presupuesto_anteproyecto/permiso_mod_jefe_depart/') }}" >En proceso de modificación</a>
                </li>
                <li>
                    <a href="{{ url('/presupuesto_anteproyecto/autorizados_mod_jefe_depart/') }}" >Requisiciones revisadas</a>
                </li>
            </ul>
            <p>
                <br>
                        ...
                        <table id="table_autorizar_doc_final" class="table table-bordered table-resposive">
                            ...
                            @foreach ($registros_envio as $registro)
                                ...
                                <tr>
                                    ...
                                    @if($registro->id_estado_requisicion == 1)
                                    <td><a   href="/presupuesto_anteproyecto/revicion_req_departamento/{{ $registro->id_req_mat_ante }}" class="btn btn-primary ">Revisar</a></td>
                                    @endif
                                    @if($registro->id_estado_requisicion == 3)
                                        <td><a   href="/presupuesto_anteproyecto/revicion_mod_req_departamento/{{ $registro->id_req_mat_ante }}" class="btn btn-primary ">Revisar modificaciones</a></td>
                                    @endif
