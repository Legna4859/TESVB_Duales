...
@section('content')
    <div class="row">
        <div class="col-md-10 col-xs-10 col-md-offset-1">
            <p>
                ...
                <span class="glyphicon glyphicon-chevron-right"></span>
                <span>Requisiciones autorizadas del anteproyecto de presupuesto</span>
            </p>
            <br>
        </div>
    </div>
        ...
        <div class="col-md-6  col-md-offset-3">
            <div class="panel panel-info">
                <div class="panel-heading">
                    <h3 class="panel-title text-center">Requisiciones autorizadas del anteproyecto de presupuesto {{ $year }}<br>
    ...
    <div class="row">
        <div class="col-md-2 col-md-offset-9">
            <a href="/presupuesto_anteproyecto/presupuesto_total_ant_excel/{{ $id_presupuesto }}" class="btn btn-primary" target="_blank"><span class="glyphicon glyphicon-export"  aria-hidden="true"></span>Exportar Excel</a>
        </div>
    </div>
    <div class="row">
        <div class="col-md-2 col-md-offset-6">
