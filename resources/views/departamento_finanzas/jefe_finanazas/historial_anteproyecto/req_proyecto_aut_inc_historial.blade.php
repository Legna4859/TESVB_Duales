...
@section('content')
    <div class="row">
        <div class="col-md-10 col-xs-10 col-md-offset-1">
            <p>
                ...
                <span class="glyphicon glyphicon-chevron-right"></span>
                <span>Requisiciones autorizadas del anteproyecto de presupuesto sin partidas presupuestales en 0</span>
            </p>
            <br>
        </div>
    </div>
        ...
        <div class="col-md-6  col-md-offset-3">
            <div class="panel panel-info">
                <div class="panel-heading">
                    <h3 class="panel-title text-center">Historial de las requisiciones autorizadas del anteproyecto de presupuesto {{ $proyecto->year }}<br>
                        ( Nombre del proyecto: {{ $proyecto->nombre_proyecto }}) <br>sin partidas presupuestales en 0
                    </h3>
                </div>
            </div>
        </div>
    ...
    <div class="row">
        <div class="col-md-2 col-md-offset-8">
            <a href="/presupuesto_anteproyecto/presupuesto_ant_excel_incompleto/{{ $id_presupuesto }}/" class="btn btn-primary" target="_blank"><span class="glyphicon glyphicon-export"  aria-hidden="true"></span>Exportar Excel</a>
        </div>
    </div>
    <div class="row">
        <div class="col-md-2 col-md-offset-6">
