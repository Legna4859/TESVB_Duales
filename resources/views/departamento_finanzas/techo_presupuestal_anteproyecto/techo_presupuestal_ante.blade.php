...
@section('content')
    ...
    <div class="row">
        <div class="col-md-2 col-md-offset-2">
            <button type="button" class="btn btn-success btn-lg" data-toggle="modal" data-target="#modal_agregar_proyecto" title="Agregar  proyecto"> <span class="glyphicon glyphicon-plus" aria-hidden="true"></span></button>
        <p><br></p>
        </div>
    </div>
...
--}}
                                ...
                                <div class="col-md-2">
                                    <button class="btn btn-primary " onclick="window.location='{{ url('/presupuesto_anteproyecto/techo_presupuestal/agregar_fuentes_f_ante/'.$presupuesto['id_proyecto'] ) }}'">Agregar capitulos</button>
