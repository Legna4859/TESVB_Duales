...
@section('content')
            ...
            <div class="col-md-10 col-md-offset-1">
                <div class="panel panel-primary">
                    <div class="panel-body">
                        ...
                        <table id="table_revision_asesor" class="table table-bordered table-resposive">
                            <thead>
                            <tr>
                                <th>No. cuenta</th>
                            ...
                            @foreach ($anteproyecto_autorizados as $anteproyecto)
                                ...
                                <tr>
                                    ...
                                    <td>{{ $anteproyecto->nom_proyecto }}</td>
                                         ...
                                         @if($anteproyecto->estado_enviado == 0)
                                        <td>
                                            No ha enviado su proyecto a sus revisores el estudiante.
                                        </td>

                                    @elseif($anteproyecto->estado_enviado== 2)
                                        <td>
                                            Esta en proceso de modificación, el estudiante debe enviarlo a sus revisores.
                                        </td>
                                    @endif
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            $('#table_revision_asesor').DataTable( );
            $("#carrera").on('change',function(e){
                var id_carrera= $("#carrera").val();
                window.location.href='/residencia/proceso_mod_anteproyecto/'+id_carrera ;
            });
