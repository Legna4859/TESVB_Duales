...
<div class="row">
    <div class="col-md-12">
        <div class="panel panel-success">
            <div class="panel-body">
                @if($alumno[0]->estado_acta_calificacion == 2)
                ...
                @else
                    ...
                    <div class="row" id="comentario_acta_calificacion" style="">
                        <div class="col-md-10 col-md-offset-1 ">
                            <div class="form-group">
                                <label for="domicilio3">Comentario para la modificación de la Acta de Calificación de Residencia Profesional</label>
                                <textarea class="form-control" id="comentario_acta_calificacion" name="comentario_acta_calificacion" rows="1"   required>{{ $alumno[0]->comentario_acta_calificacion }}</textarea>
                            </div>
                        </div>
                    </div>
...
<div class="row">
    <div class="col-md-12">
        <div class="panel panel-success">
            <div class="panel-body">
                @if($alumno[0]->estado_proyecto == 2)
                    <div class="col-md-10 col-md-offset-1" style="color: #FF0000">
                        <label>Proyecto Completo de Residencia Profesional: </label>    <b>Autorizado</b>
                    </div>
                    <input type="hidden" name="proyecto" id="proyecto" value="{{$alumno[0]->estado_proyecto}}" >

                @else
                    <div class="col-md-7 col-md-offset-1">
                        <label>Proyecto Completo de Residencia Profesional: <b style="color: red">Debio ser enviado a su correo</b></label>
                    </div>
                    <div class="col-md-3" style="text-align: left">
                    ...
                    <div class="row" id="comentario_proyecto" style="">
                        <div class="col-md-10 col-md-offset-1 ">
                            <div class="form-group">
                                <label for="domicilio3">Comentario para la modificación del Proyecto Completo de Residencia Profesional</label>
                                <textarea class="form-control" id="comentario_proyecto" name="comentario_proyecto" rows="1"   required>{{ $alumno[0]->comentario_proyecto}}</textarea>
                            </div>
                        </div>
                    </div>
        ...
        <div class="panel panel-success">
            <div class="panel-body">
                @if($alumno[0]->estado_portada == 2)
                    ...
                    <input type="hidden" name="portada" id="portada" value="{{$alumno[0]->estado_portada}}" >
                ...
                @else
                    ...
                    <div class="row" id="comentario_portada" style="">
                        <div class="col-md-10 col-md-offset-1 ">
                            <div class="form-group">
                                <label for="domicilio3">Comentario para la modificación de la Portada de Proyecto de Residencia Profesional</label>
                                <textarea class="form-control" id="comentario_portada" name="comentario_portada" rows="1"   required>{{ $alumno[0]->comentario_portada }}</textarea>
                            </div>
                        </div>
                    </div>
...
<div class="row">
    <div class="col-md-12">
        <div class="panel panel-success">
            <div class="panel-body">
                @if($alumno[0]->estado_evaluacion_final_residencia == 2)
                    <div class="col-md-10 col-md-offset-1" style="color: #FF0000">
                    ...
                    <input type="hidden" name="evaluacion_final_residencia" id="evaluacion_final_residencia" value="{{$alumno[0]->estado_evaluacion_final_residencia}}" >
                ...
                @else
                    ...
                    <div class="row" id="comentario_evaluacion_final_residencia" style="">
                        <div class="col-md-10 col-md-offset-1 ">
                            <div class="form-group">
                                <label for="domicilio3">Comentario para la modificación de la Evaluación Final de Residencia Profesional</label>
                                <textarea class="form-control" id="comentario_evaluacion_final_residencia" name="comentario_evaluacion_final_residencia" rows="1"   required>{{ $alumno[0]->comentario_evaluacion_final_residencia }}</textarea>
                            </div>
                        </div>
                    </div>
...
<div class="row">
    <div class="col-md-12">
        <div class="panel panel-success">
            <div class="panel-body">
                @if($alumno[0]->estado_oficio_aceptacion_informe_interno == 2)
                    <div class="col-md-10 col-md-offset-1" style="color: #FF0000">
                    ...
                    <input type="hidden" name="oficio_aceptacion_informe_interno" id="oficio_aceptacion_informe_interno" value="{{$alumno[0]->estado_oficio_aceptacion_informe_interno}}" >
                ...
                @else
                    ...
                    <div class="row" id="comentario_oficio_aceptacion_informe_interno" style="">
                        <div class="col-md-10 col-md-offset-1 ">
                            <div class="form-group">
                                <label for="domicilio3">Comentario para la modificación del Oficio de Aceptación de Informe  Final del Asesor  Interno</label>
                                <textarea class="form-control" id="comentario_oficio_aceptacion_informe_interno" name="comentario_oficio_aceptacion_informe_interno" rows="1"   required>{{ $alumno[0]->comentario_oficio_aceptacion_informe_interno }}</textarea>
                            </div>
                        </div>
                    </div>
...
<div class="row">
    <div class="col-md-12">
        <div class="panel panel-success">
            <div class="panel-body">
                @if($alumno[0]->estado_formato_evaluacion == 2)
                    <div class="col-md-10 col-md-offset-1" style="color: #FF0000">
                    ...
                    <input type="hidden" name="formato_evaluacion" id="formato_evaluacion" value="{{$alumno[0]->estado_formato_evaluacion}}" >
                ...
                @else
                    ...
                    <div class="row" id="comentario_formato_evaluacion" style="">
                        <div class="col-md-10 col-md-offset-1 ">
                            <div class="form-group">
                                <label for="domicilio3">Comentario para la modificación del Formato de Evaluación</label>
                                <textarea class="form-control" id="comentario_formato_evaluacion" name="comentario_formato_evaluacion" rows="1"   required>{{ $alumno[0]->comentario_formato_evaluacion }}</textarea>
                            </div>
                        </div>
                    </div>
...
<div class="row">
    <div class="col-md-12">
        <div class="panel panel-success">
            <div class="panel-body">
                @if($alumno[0]->estado_oficio_aceptacion_informe_revisor == 2)
                    <div class="col-md-10 col-md-offset-1" style="color: #FF0000">
                    ...
                    <input type="hidden" name="oficio_aceptacion_informe_revisor" id="oficio_aceptacion_informe_revisor" value="{{$alumno[0]->estado_oficio_aceptacion_informe_revisor}}" >
                ...
                @else
                    ...
                    <div class="row" id="comentario_oficio_aceptacion_informe_revisor" style="">
                        <div class="col-md-10 col-md-offset-1 ">
                            <div class="form-group">
                                <label for="domicilio3">Comentario para la modificación del Oficio de Aceptación de Informe Final del Revisor</label>
                                <textarea class="form-control" id="comentario_oficio_aceptacion_informe_revisor" name="comentario_oficio_aceptacion_informe_revisor" rows="1"   required>{{ $alumno[0]->comentario_oficio_aceptacion_informe_revisor }}</textarea>
                            </div>
                        </div>
                    </div>
...
<div class="row">
    <div class="col-md-12">
        <div class="panel panel-success">
            <div class="panel-body">
                @if($alumno[0]->estado_oficio_aceptacion_informe_externo == 2)
                    <div class="col-md-10 col-md-offset-1" style="color: #FF0000">
                    ...
                    <input type="hidden" name="oficio_aceptacion_informe_externo" id="oficio_aceptacion_informe_externo" value="{{$alumno[0]->estado_oficio_aceptacion_informe_externo}}" >
                ...
                @else
                    ...
                    <div class="row" id="comentario_oficio_aceptacion_informe_externo" style="">
                        <div class="col-md-10 col-md-offset-1 ">
                            <div class="form-group">
                                <label for="domicilio3">Comentario para la modificación del Oficio de Aceptación de Informe Final del Asesor Externo</label>
                                <textarea class="form-control" id="comentario_oficio_aceptacion_informe_externo" name="comentario_oficio_aceptacion_informe_externo" rows="1"   required>{{ $alumno[0]->comentario_oficio_aceptacion_informe_externo }}</textarea>
                            </div>
                        </div>
                    </div>
...
<div class="row">
    <div class="col-md-12">
        <div class="panel panel-success">
            <div class="panel-body">
                @if($alumno[0]->estado_formato_hora == 2)
                    <div class="col-md-10 col-md-offset-1" style="color: #FF0000">
                    ...
                    <input type="hidden" name="formato_hora" id="formato_hora" value="{{$alumno[0]->estado_formato_hora}}" >
                ...
                @else
                    ...
                    <div class="row" id="comentario_formato_hora" style="">
                        <div class="col-md-10 col-md-offset-1 ">
                            <div class="form-group">
                                <label for="domicilio3">Comentario para la modificación del Formato de Horas</label>
                                <textarea class="form-control" id="comentario_formato_hora" name="comentario_formato_hora" rows="1"   required>{{ $alumno[0]->comentario_formato_hora }}</textarea>
                            </div>
                        </div>
                    </div>
...
<div class="row">
    <div class="col-md-12">
        <div class="panel panel-success">
            <div class="panel-body">
                @if($alumno[0]->estado_seguimiento_interno == 2)
                    <div class="col-md-10 col-md-offset-1" style="color: #FF0000">
                    ...
                    <input type="hidden" name="seguimiento_interno" id="seguimiento_interno" value="{{$alumno[0]->estado_seguimiento_interno}}" >
                ...
                @else
                    ...
                    <div class="row" id="comentario_seguimiento_interno" style="">
                        <div class="col-md-10 col-md-offset-1 ">
                            <div class="form-group">
                                <label for="domicilio3">Comentario para la modificación del Formato de Seguimiento Interno</label>
                                <textarea class="form-control" id="comentario_seguimiento_interno" name="comentario_seguimiento_interno" rows="1"   required>{{ $alumno[0]->comentario_seguimiento_interno }}</textarea>
                            </div>
                        </div>
                    </div>
...
<div class="row">
    <div class="col-md-12">
        <div class="panel panel-success">
            <div class="panel-body">
                @if($alumno[0]->estado_seguimiento_externo == 2)
                    <div class="col-md-10 col-md-offset-1" style="color: #FF0000">
                ...
                @else
                    ...
                    <div class="row" id="comentario_seguimiento_externo" style="">
                        <div class="col-md-10 col-md-offset-1 ">
                            <div class="form-group">
                                <label for="domicilio3">Comentario para la modificación del Formato de Seguimiento Externo</label>
                                <textarea class="form-control" id="comentario_seguimiento_externo" name="comentario_seguimiento_externo" rows="1"   required>{{ $alumno[0]->comentario_seguimiento_externo }}</textarea>
                            </div>
                        </div>
                    </div>
