                                        ...
                                        @foreach($materia['grupos'] as $grupo)
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <a href="/servicios_escolares/acciones_cc_academico/{{$docente['id_personal']}}/{{$materia['id_materia']}}/{{$grupo['id_grupo']}}" class="btn btn-primary tooltip-options link" data-toggle="tooltip" data-placement="top" title="Evaluaciones"><span class="oi oi-pencil"></span></a>
                                                </td>
                                            </tr>
                                        @endforeach
                                        </tbody>
