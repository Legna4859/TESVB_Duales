        ...
        @if($calificar_sumativa == 0)
            ...
            <div class="row col-md-12">
                <div class="col-md-10 col-md-offset-1 ">
                    <label class=" alert alert-danger text-center"  data-toggle="tab" ><h3>Ya se registraron calificaciones sumativas, por lo cual ya no se pueden modificar calificaciones ordinarias.
                        </h3></label>
                </div>
            </div>
            ...
            <div class="panel">
                @if($calificar_sumativa == 0)
                    <div class="col-md-2 col-md-offset-8">
                        <a href="/generar_excel/acta_constitutiva/{{ $id_docente }}/{{ $id_materia }}/{{ $id_grupo }}" class="btn btn-success" target="_blank"><span class="glyphicon glyphicon-print"  aria-hidden="true"></span>Exportar a excel</a>
                    </div>
                @else
                <div class="col-md-2 col-md-offset-8">
                    <a href="/generar_excel/acta_constitutiva_sumativa/{{ $id_docente }}/{{ $id_materia }}/{{ $id_grupo }}" class="btn btn-success" target="_blank"><span class="glyphicon glyphicon-print"  aria-hidden="true"></span>Exportar a excel</a>
                </div>
                @endif
                        ...
                        @foreach($alumnos as $alumno)
                            <tr class="text-center">
                              ...
                              @if($calificar_sumativa == 0)
                                    ...
                                    @else
                                <td><span ><a href="#!" class="btn btn-danger tooltip-options " data-token="{{ csrf_token() }}" data-toggle="tooltip" data-placement="top" title="Modificar calificaciones" disabled><span class="glyphicon glyphicon-pencil"></span></a></span></td>
                            @endif
                            </tr>
                        @endforeach
                        <tr>
                ...
                $("#modifica_calificacion{{$alumno['cuenta']}}").on("click",function()
                {
                    ...
                    else if(calificacion>0 && calificacion<70)
                    {
                        Swal({
                            ...
                            if (result.value) {
                                $.get('/servicios_escolares/actualizaCalificacion',{id_evaluacion:id_evaluacion,calificacion:calificacion,id_materia:id_materia,docente:docente},function(request)
                                {
                                    swal({
                                        type: "success",
