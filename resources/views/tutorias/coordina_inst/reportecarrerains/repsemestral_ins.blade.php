                ...
                <div class="row">
                    <div class="col-12 pb-3">
                         <div class="col-12 pb-3">
                            ...
                            <a href="{{url('/tutorias/reporteinstitucional/repsemestralcarrera')}}" class="font-weight-bold h6 pb-1">{{\Illuminate\Support\Facades\Session::get('coordinador')>1?'Regresar':'Regresar'}}</a>
                        </div>
                    </div>
                </div>
                <div class="row">
