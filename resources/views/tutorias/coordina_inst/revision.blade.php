...
@section('content')
    <div class="container" id="ind">
        ...
        <div class="row" v-if="menucarrera" >
                                                        ...
                                                        <data-table class=" col-12 table table-sm" :data="alumno" :columns-to-display="gridColumns1" :filter-key="searchQuery">
                                                            ...
                                                            <template slot="Estrategia" scope="alumno">
                                                                <div class="text-center" v-if="alumno.entry.id_estrategia==2">
                                                                    <button class="btn btn-outline-primary m-1" @click="verestrategia(alumno.entry)" data-toggle="tooltip" data-placement="bottom" title="Ver Estrategia"><i class="far fa-eye"></i></button>
                                                                </div>
                                                            </template>
            ...
            @include('tutorias.coordina_inst.modalsugerencia')
            @include('tutorias.coordina_inst.modalestrategia')
            ...
            methods:{
                ...
                reporte:function () {
                    ...
                    for(let p in this.arreglo_graficas)
                    {
                        ...
                        var obj = {}, exportUrl = 'http://192.168.43.226:8004/';
                        obj.type = 'image/png';
                        obj.async = true;
