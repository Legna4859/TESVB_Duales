        ...
        <div class="row">
            ...
            <div class="row col-md-11 col-md-offset-1">
                <ul class="nav nav-tabs">
                    <li class="active"><a href="#">Autorizar datos personales de los estudiantes de titulación</a>
                    </li>
                    <li>
                        <a href="{{ url('/titulacion/proceso_modificacion_datos_alumno/'.$id_carrera ) }}" >En proceso de modificación</a>
                    </li>
                    <li>
                                    ...
                                    <tr>
                                        ...
                                        <td>{{$alumno->telefono}}</td>
                                          @if($alumno->id_estado_enviado == 1)
                                            <td>
                                                <a class="btn btn-primary" href="{{asset('/titulacion/revisar_datos_generales/'.$alumno->id_alumno)}}" >Autorizar</a>
                                            </td>
                                        @endif
                                        @if($alumno->id_estado_enviado == 3)
                                            <td>
                                                <a class="btn btn-primary" href="{{asset('/titulacion/revisar_datos_generales/'.$alumno->id_alumno)}}" >Autorizar correciones</a>
                                            </td>
                                        @endif
