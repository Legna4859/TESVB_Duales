        ...
        <div class="row">
            ...
            <div class="row col-md-11 col-md-offset-1">
                <ul class="nav nav-tabs">
                    ...
                    <li class="active">
                        <a href="#">Estudiantes con datos personales autorizados</a>
                    </li>
                            ...
                            <table class="table table-bordered " Style="background: white;" id="tabla_revicion">
                                ...
                                @foreach($registro_alumnos as $alumno)
                                    <tr>
                                        ...
                                        <td>
                                            <a class="btn btn-primary" href="{{asset('/titulacion/ver_datos_per_ti_aut/'.$alumno->id_alumno).'/'.$id_carrera}}" >Ver</a>
                                        </td>
