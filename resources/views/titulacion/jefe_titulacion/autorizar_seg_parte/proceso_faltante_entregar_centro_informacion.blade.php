        ...
        <div class="row">
            ...
            <div class="row col-md-11 col-md-offset-1">
                <ul class="nav nav-tabs">
                    ...
                    <li class="active">
                        <a href="#">Estudiantes faltante entregar PDF en el centro de información</a>
                    </li>
                    <li>
                        ...
                        <div class=" col-md-12 ">
                            ...
                            <table class="table table-bordered " Style="background: white;" id="tabla_revicion">
                                ...
                                <tr>
                                    ...
                                    <th>TELEFONO</th>
                                    <th>VER INFORMACIÓN AUTORIZADA</th>
                                ...
                                @foreach($registro_alumnos as $alumno)
                                    <tr>
                                        ...
                                        <td>
                                            <a class="btn btn-primary" href="{{asset('/titulacion/ver_datos_personales_alumno_ti/'.$alumno->id_alumno.'/'.$id_carrera)}}" >Ver</a>
                                        </td>
