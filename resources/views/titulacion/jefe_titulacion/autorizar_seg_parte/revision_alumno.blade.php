...
@section('content')
        ...
        <div class="row">
            <div class="col-md-10 col-xs-10 col-md-offset-1">
                <p>
                    ...
                    <a href="{{url("/titulacion/autorizar_datos_personales")}}">Autorizar datos personales de los estudiantes de titulación </a>
                    <span class="glyphicon glyphicon-chevron-right"></span>
                    <span>Revisión del Registro de Datos Personales</span>
                </p>
                <br>
            </div>
        </div>
            ...
            <div class="col-md-8 col-md-offset-2">
                <div class="panel panel-info">
                    <div class="panel-heading">
                        <h3 class="panel-title text-center">Revisión del Registro de Datos Personales <br>
                        </h3>
                    </div>
                </div>
            </div>
  ...
  background-color: lightblue;">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3">
                                    <label for="domicilio3">Colonia<b style="color:red; font-size:23px;">*</b></label>
  ...
  background-color: lightblue;">
                            ...
                            <div class="row">
                                <div class="col-md-3 col-md-offset-5">
                                    <button type="button " class="btn btn-primary btn-lg" @click="modificar_datos();" >Guardar modificación de los datos</button>
                                    <p><br></p>
                                </div>
                            </div>
                            <div class="row">
  ...
  background-color: black;">
                            ...
                            <template v-if="docu.id_tipo_donaciones  == 3">
                                <div class="row">
                                    ...
                                    <button   @click="enviar_modificacion_alumno();"  title="Enviar modificación al estudiantw"  type="button" class="btn btn-warning btn-lg flotante">
                                        Enviar modificaciones
                                    </button>
                                    </div>
                                    <div class="col-md-3 ">
                                        <button   @click="autorizar_datos_alumno();"  title="Autorizar los datos personales del estudiante"  type="button" class="btn btn-success btn-lg flotante">
                                            Autorizar datos personales
                                        </button>
                                    </div>
  ...
  background-color: black;">
                                ...
                                <template v-if="contar_computo  > 0">
                                    <div class="row">
                                        <div class="col-md-3 col-md-offset-4">
                                            <button   @click="enviar_modificacion_alumno();"  title="Enviar modificación al estudiante"  type="button" class="btn btn-warning btn-lg flotante">
                                                Enviar modificaciones
                                            </button>
                                        </div>
                                        <div class="col-md-3 ">
  ...
  background-color: black;">
                    ...
                    @include('titulacion.jefe_titulacion.autorizar_seg_parte.modal_enviar_modificacion_dat')
                    @include('titulacion.jefe_titulacion.autorizar_seg_parte.autorizacion_dat_personales')
    ...
    <script>
        new Vue({
            ...
            methods: {
                    ...
                    if(this.contar_formulario == 9){
                        if(this.docu.reprobacion_mat > 0){
                            ...
                            swal({
                                position: "top",
                                type: "warning",
                                title: "Selecciona si reporbaste alguna materia",
                                showConfirmButton: false,
                                timer: 3500
                            });
                        }
                    ...
                    if(this.contar_formulario == 19){
                        if(this.docu.red_social !=""){
                            ...
                            swal({
                                position: "top",
                                type: "warning",
                                title: "Ingresa red social que usas habitualmente",
                                showConfirmButton: false,
                                timer: 3500
                            });
                        }
                ...
                async enviar_modificacion_alumno(){
                    this.modal_enviar_moficaciones=1;
                    this.comentario_modificacion="";
                    this.estado_guardar_autorizar=false;

                },
                async enviar_modificaciones(){
                    if(this.comentario_modificacion !=""){
                        this.estado_guardar_autorizar=true;
                        window.location.href = '/titulacion/enviar_modificaciones/'+this.docu.id_reg_dato_alum+'/'+this.comentario_modificacion;
                        swal({
                            position: "top",
                            type: "success",
                            title: "Envio exitoso",
                ...
                async autorizar_datos_alumno(){
                    this.modal_enviar_aurizacion=1;
                    this.estado_guardar_autorizar=false;
                },
                ...
                async enviar_autorizacion(){
                    this.cerrarModal_autorizar();
                    this.estado_guardar_autorizar=true;
                    window.location.href = '/titulacion/enviar_autorizacion/'+this.docu.id_reg_dato_alum;
                    swal({
                        position: "top",
                        type: "success",
                ...
                async cerrarModal_enviar_modificacion(){
                    this.modal_enviar_moficaciones=0;
                },
                async cerrarModal_autorizar(){
                     this.modal_enviar_aurizacion=0;
                }
