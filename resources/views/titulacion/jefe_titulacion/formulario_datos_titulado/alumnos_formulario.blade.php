    ...
    <main class="col-md-12">
        ...
        <div class="row col-md-11 col-md-offset-1">
            <ul class="nav nav-tabs">
                <li class="active"><a href="#">Estudiantes para autorizar titulación</a></li>
                <li>
        ...
        <div class="col-md-10 col-md-offset-1">
                <table id="tabla_envio" class="table table-bordered table-resposive">
                    ...
                    @foreach($alumnos as $alumno)
                       ...
                       {{--     <td> <button type="button" class="btn btn-primary center" onclick="window.open('{{url('/titulacion/descargar_acta_titulacion/'.$dato['id_alumno'] )}}')">Imprimir</button></td>--}}

                            <td><button class="btn btn-success " onclick="window.location='{{ url('/titulacion/formulario_datos_titulado/dato_alumno/'.$alumno->id_alumno) }}'">Autorizar titulación</button></td>
                        </tr>
                    @endforeach
                    </tbody>
                </table>
