        ...
        <div class="row">
            <div class="col-md-10 col-xs-10 col-md-offset-1">
                <p>
                    ...
                    <a href="{{url("/titulacion/documentacion_requisitos_titulacion")}}">Enviar documentación de los requisitos de Titulación </a>
                    <span class="glyphicon glyphicon-chevron-right"></span>
                    <span>Documentación de Requisitos de Titulación Autorizada </span>
                ...
                <div class="panel panel-success">
                    <div class="panel-heading">
                        <h3 class="panel-title text-center">Documentación de Requisitos de Titulación Autorizada <br>
                            ...
                            Nombre del estudiante: {{ $alumno->nombre }}  {{ $alumno->apaterno }}  {{ $alumno->amaterno }}
                        </h3>
                    </div>
                </div>
            </div>
