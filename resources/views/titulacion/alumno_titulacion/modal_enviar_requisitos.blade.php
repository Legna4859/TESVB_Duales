    ...
    <div class="modal-dialog ">
        ...
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title" style=" text-align: center;">Enviar requisitos de titulación</h4>
            </div>
            <div class="modal-body">
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-success" @click="guardar_enviar();" :disabled="estado_enviar">Enviar</button>
                </div>
            </div>
        </div>
