...
<head>
    ...
    <meta http-equiv="X-UA-Compatible" content="ie=edge">
		<title> SUMATIVAS {{ $mat->nombre }}</title>
</head>
<body>
<?php
$mes=strftime("%B");
...
<img src="img/logo3.PNG" alt="" width="30%" style="margin-left: 44%;">
    <h5 style="text-align: center; background: #cccccc;margin-top:1%">ACTA DE CALIFICACIONES DE EVALUACIÓN SUMATIVA DE COMPLEMENTACIÓN</h5>
        ...
        <div class="panel">
            <div class="panel-body">
                <table style="font-size: 11px; text-align: center;  " cellspacing="0" cellpadding="0">
                    ...
                    <tr>
                        <th rowspan="2" style="border:1px solid black">NP</th>
                        <th rowspan="2" style="border:1px solid black">No. CTA</th>
                        <th rowspan="2" style="border:1px solid black">ALUMNO</th>
                        ...
                        <th style="border:1px solid black; text-align: center">T.E.</th>
                    </tr>
                    <tbody>
                    ...
                    @foreach($alumnos as $alumno)
                        <tr class="text-center">
                            ...
                            @for ($i = 1; $i <= $unidades_restantes; $i++)
                                <td style="border: 1px solid black; background: #FFEE62; ">N.A</td>
                            @endfor
                            <?php  $porcentaje_gen+=$alumno['repeticion']==false ? '1' : '0'; $cont_gen++;?>
                            @if($alumno['estado_validacion'] == 10)
                                <td style="border: 1px solid black; background: #a94442; ">BAJA</td>
                                @else
                            @if($alumno['promedio']>=70 and $alumno['repeticion']==false)
                                <td style="border: 1px solid black; background:white; " >{{ $alumno['promedio'] }}</td>
                            @else
                                <td style="border: 1px solid black; background: #a94442; ">N.A</td>
                            @endif
                            @endif
                    ...
                    <tr>
                        ...
                        <td style="border: 1px solid black;background: {{ $imp_porcentaje>=70 ? '#3c763d' : '#a94442' }}; color: #ffffff">{{ round($imp_porcentaje,2) }}%</td>
                        <td></td>
                    </tr>
                    </tbody>
                </table>
