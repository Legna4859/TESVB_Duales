...
class Pre_excel_ante_incController extends Controller
{
    public function presupuesto_ant_excel_incompleto($id_presupuesto)
    {
               ...
               WHERE id_capitulo = ' . $presupuesto->id_capitulo . ' ORDER BY `clave_presupuestal` ASC');
                ...
                foreach ($array_capitulos as $cap) {
                    ...
                    foreach ($cap['array_partidas'] as $partida) {
                        if ($partida['suma_presupuestal_year'] == 0) {
...
//dd($proyecto);
                ...
                $sheet->loadView('departamento_finanzas.jefe_finanazas.requisiciones_autorizadas_pro.excel_req_proy_inc', compact('id_presupuesto', 'array_cap', 'array_capitulos', 'etiqueta', 'proyecto'));
    ...
    public function pres_capitulo_ant_excel_inc($id_fuente_financiamiento)
    {
        Session::put('id_fuente_financiamiento', $id_fuente_financiamiento);
        Excel::create('Proyecto_capitulo_inc', function ($excel) {

            $excel->sheet('Requisiciones_capitulo_inc', function ($sheet) {
                $etiqueta = DB::selectOne('SELECT * FROM `etiqueta` WHERE `id_etiqueta` = 1');
...
// Set font with ->setStyle()`
            ...
            */
                ...
                //dd($presupuesto_ante_proy);
                $sheet->loadView('departamento_finanzas.jefe_finanazas.requisiciones_autorizadas_pro.excel_req_cap_incompleto', compact('id_presupuesto', 'array_cap', 'array_capitulos', 'etiqueta', 'proyecto','fuente_financiamiento'));
    ...
    public function pre_mes_ant_excel_inc($id_presupuesto, $id_mes)
    {
...
// Set font with ->setStyle()`
            ...
            */
            ...
            $sheet->cell('A189:CC189', function($cell) {
                ...
                //dd($presupuesto_ante_proy);
                $sheet->loadView('departamento_finanzas.jefe_finanazas.requisiciones_autorizadas_pro.excel_req_ante_mes_inc', compact('id_presupuesto', 'array_cap', 'array_capitulos', 'id_mes', 'etiqueta', 'proyecto','mes'));
    ...
    public function presupuesto_metas_ant_excel_inc($id_presupuesto,$id_meta){
        Session::put('id_presupuest',$id_presupuesto);
...
//dd($proyecto);
                //dd($presupuesto_ante_proy);
                $sheet->loadView('departamento_finanzas.jefe_finanazas.requisiciones_autorizadas_pro.excel_req_ante_meta_inc',compact('meta','id_presupuesto','array_cap','array_capitulos','etiqueta','proyecto'));
