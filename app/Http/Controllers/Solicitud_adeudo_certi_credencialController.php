...
class Solicitud_adeudo_certi_credencialController extends Controller
{
    public  function index($id_alumno,$id_tipo){
        ...
        if($id_tipo ==1)
        {
            $texto="El Tecnológico de Estudios Superiores de Valle de Bravo hace constar que el (la) C. ".$nombre_alumno." con número de cuenta ".$cuenta.", es egresado (a) de esta institución, y no presenta adeudos en las áreas de: Dirección General, Direcciones de Área, Subdirecciones, Jefaturas de División, Jefaturas de Departamento, Bolsa de Trabajo y Seguimiento de Egresados, Centro de Información y Centro de Cómputo.";

        }
        elseif($id_tipo == 2)
        {
            $texto="El Tecnológico de Estudios Superiores de Valle de Bravo hace constar que el (la) C. ".$nombre_alumno." con número de cuenta ".$cuenta.", es estudiante  de esta institución, y no presenta adeudos en las áreas de: Dirección General, Direcciones de Área, Subdirecciones, Jefaturas de División, Jefaturas de Departamento, Bolsa de Trabajo y Seguimiento de Egresados, Centro de Información y Centro de Cómputo.";
        ...
        $pdf->Ln(15);
        $pdf->SetFont('Arial','B','12');
        $pdf->Cell(175,5,utf8_decode("L. EN C. ROMULO ESQUIVEL REYES"),0,1,'C');
        $pdf->Cell(175,5,utf8_decode("SUBDIRECCIÓN DE SERVICIOS ESCOLARES"),0,1,'C');
        $pdf->Output();
        exit();
